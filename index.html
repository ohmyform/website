	...
	<section>
		<div class="container flex">
			<div class="text editable">
				...
				<p>With TellForm you'll get all the features you need to run, administer, analyze and distribute forms for free.</p>
			</div>
			<div class="image">
				<img src="/images/macbook_screenshot_original.png" alt="Screenshot" class="screenshot editable" />
			</div>
		</div>
	</section>
	...
	<section>
		<div class="container flex">
			<div class="text editable">
				...
				<p>With our opensource community, TellForm is always improving and is vetted by top programming experts around the world, ensuring that our code is top-notch, eliminating potential bugs and errors.</p>
			</div>
			<div class="image">
				<img src="/images/tellform_github_cropped.png" alt="Screenshot" class="screenshot editable" />
			</div>
		</div>
	</section>
